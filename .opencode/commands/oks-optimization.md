...
echo ""
echo "从设计文档中获取性能目标："
grep -A 5 "性能目标\|性能设计" "$REPO_ROOT/docs/designs/$PROJECT_NAME/$ARGUMENTS.md" 2>/dev/null | head -10 || echo "- 未找到性能目标定义"
...
> **性能目标来源**: 从设计文档 `docs/designs/{project}/{feature}.md` 的"性能设计"章节获取
